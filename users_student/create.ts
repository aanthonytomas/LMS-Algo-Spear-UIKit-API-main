...
export async function createStudent({ firstname, lastname, email, password, confirm_password, created_by }:StudentCreateProps):Promise<any> {
    return new Promise( async (resolve) => {
        if(firstname == '') {
            ...
            var user_refid = createReferenceID('STD');
